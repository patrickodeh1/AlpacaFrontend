        ...
        <aside className="col-span-12 lg:col-span-3">
          <div className="space-y-4 sticky top-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <a href="/admin/prop_firm/propfirmplan/" target="_blank" rel="noreferrer">
                ...
                <a href="/admin/prop_firm/propfirmaccount/" target="_blank" rel="noreferrer">
                  <Button variant="ghost" className="w-full justify-between" size="sm">
                    <span className="flex items-center">
                      <Wallet className="w-4 h-4 mr-2" />
                      Accounts
                ...
                <a href="/admin/prop_firm/payout/" target="_blank" rel="noreferrer">
                  <Button variant="ghost" className="w-full justify-between" size="sm">
                    <span className="flex items-center">
                      <DollarSign className="w-4 h-4 mr-2" />
                      Payouts
                ...
                <a href="/admin/prop_firm/ruleviolation/" target="_blank" rel="noreferrer">
                  <Button variant="ghost" className="w-full justify-between" size="sm">
                    <span className="flex items-center">
                      <AlertTriangle className="w-4 h-4 mr-2" />
                      Violations
                ...
                <Separator className="my-2" />
                <a href="/admin/core/asset/" target="_blank" rel="noreferrer">
                  <Button variant="ghost" className="w-full justify-between" size="sm">
                    <span className="flex items-center">
                      <Activity className="w-4 h-4 mr-2" />
                      Assets
                ...
                <a href="/admin/core/watchlist/" target="_blank" rel="noreferrer">
                  <Button variant="ghost" className="w-full justify-between" size="sm">
                    <span className="flex items-center">
                      <Eye className="w-4 h-4 mr-2" />
                      Watchlists
                ...
                <a href="/admin/account/user/" target="_blank" rel="noreferrer">
                  <Button variant="ghost" className="w-full justify-between" size="sm">
                    <span className="flex items-center">
                      <Users className="w-4 h-4 mr-2" />
                      Users
